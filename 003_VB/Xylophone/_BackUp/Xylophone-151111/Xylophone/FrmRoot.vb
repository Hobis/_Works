...
#Region "Case Init's"
    ...
    Private Sub p_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Me.Text = "Xylophone Ver 1.07"
        Me.Text = "실로폰 - Ver 1.05"
...
#End Region
    ...
    Private Sub FrmRoot_DragDrop(sender As Object, e As DragEventArgs) Handles MyBase.DragDrop
    ...
    Private Sub FrmRoot_DragEnter(sender As Object, e As DragEventArgs) Handles MyBase.DragEnter
