package works
{
	...
	public final class TW_SoundPlay implements ICallBack
	{
		// ::
		public function TW_SoundPlay(url:String, context:SoundLoaderContext, callBack:Function)
		{
		...
		// ::
		public function play(startTime:Number, endTime:Number, loops:uint = 1):void
		{
			this.stop();
